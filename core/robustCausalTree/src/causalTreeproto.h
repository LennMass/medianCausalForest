...
void totH_rundown(pNode tree, int obs, double *cp, double *xpred, double *xtemp, int k, 
                  double alpha, double xtrain_to_est_ratio, double propensity);
void totA_rundown(pNode tree, int obs, double *cp, double *xpred, double *xtemp, int k, double alpha);

void fitH_rundown(pNode tree, int obs, double *cp, double *xpred, double *xtemp, int k, 
                 double alpha, double xtrain_to_est_ratio, double propensity);
void fitA_rundown(pNode tree, int obs, double *cp, double *xpred, double *xtemp, int k, double alpha);
