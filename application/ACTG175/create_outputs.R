...
path_in <- "application/ACTG175"
path_out <- "output/application_plots/"

# load config file
source("01_config.R")

CF_estimates <- readRDS(here::here(path_in, "results/ACTG175_CF_estimates.rds"))
...
# ATE competitors
res_table <- readRDS(here::here(path_in, "results/ACTG175_ATE_competitors.rds")) 
...
saveRDS(res_table, here::here(paste0("output/application_tables/ATE_table_ACTG175.rds")))
